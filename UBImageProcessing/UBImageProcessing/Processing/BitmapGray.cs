...
{
    //Gets the image and sets it as GreyScale Image
    // Most of the code is referenced from open Source Project and Modified accordingly to suit 
    //our Project UBImageProcessing

    internal unsafe class BitmapGrey
    {
        ...
        internal BitmapGrey(Bitmap bitmap)
        {
            this.bitmap = bitmap;
        }
