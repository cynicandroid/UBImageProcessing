...
namespace UBImageProcessing.Processing
{
    
    // This Algorithm is the basis of this UBImageProcessing for Image Comparision
    // Normalized Levenshtein Distance Metric is an Algorithm for finding Normalized edit distance betwwen
    //two matric points 
    // This Algorithm is used here for finding image pixel similarity between two images
    ...
    internal class Levenshtein : IComparer<ComparableBitmap>
    {
        ...
        /// <summary>
        /// parameters are types of Items,first enumberable,second enumberable 
        /// It returns the Edit distance between two passed enumberable
        /// </summary>
    ...
    internal class ComparableBitmap : BitmapGrey, IEnumerable<byte>
    {
        ...
        public ComparableBitmap(string path)
            : base(null)
        {
